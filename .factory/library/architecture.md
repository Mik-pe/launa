...
- **launa-mqtt** — MQTT topics, discovery builder (20 HA entities), command parser (allowlist), state JSON serializer. no_std compatible. DiscoveryBuilder generates all HA auto-discovery configs with origin, sw_version, entity_category.
