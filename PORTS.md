...
-------|-----------------------|--------------------|-------|-----------|---------------------
A      | /dev/cu.usbserial-3   | 1c:c3:ab:ba:83:c8 | 4MB   | TX+RX OK | Main app firmware
...
```
# Flash device A
cargo xtask flash --port /dev/cu.usbserial-3
cargo xtask config-flash --port /dev/cu.usbserial-3
